...
<head>
    ...
    <title><?php echo htmlspecialchars((isset($systemSetting['site_name']) && $systemSetting['site_name'] !== '') ? $systemSetting['site_name'] : $appName, ENT_QUOTES, 'UTF-8'); ?></title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="/public/index.php?route=landing">
            <span class="fw-bold"><?php echo htmlspecialchars((isset($systemSetting['site_name']) && $systemSetting['site_name'] !== '') ? $systemSetting['site_name'] : $appName, ENT_QUOTES, 'UTF-8'); ?></span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link <?php echo ($route === 'login' || $route === '' || $route === 'index.php') ? 'active' : ''; ?>" href="/public/index.php?route=login">普通登录</a>
                </li>
    ...
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center small text-muted">
        ...
        <div class="mt-2 mt-md-0">
            ...
            if ($copyright !== '') {
                ...
                $fallbackName = (isset($systemSetting['site_name']) && $systemSetting['site_name'] !== '') ? $systemSetting['site_name'] : $appName;
                echo '&copy; ' . date('Y') . ' ' . htmlspecialchars($fallbackName, ENT_QUOTES, 'UTF-8');
            }
            ?>
        </div>
    </div>
