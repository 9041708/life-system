                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="<?= $isPaid ? 'table-success bg-opacity-10' : '' ?>">
                                    ...
                                    <td>
                                        <span class="<?= $isOverdue ? 'text-danger fw-bold' : ($isPaid ? 'text-muted' : '') ?>">
                                            <?= date('Y-m-d', strtotime($payment['due_date'])) ?>
                                        </span>
                                    </td>
                                    <td class="<?= $isPaid ? 'text-muted' : '' ?>">¥<?= number_format($payment['principal_amount'], 2) ?></td>
                                    <td class="<?= $isPaid ? 'text-muted' : '' ?>">¥<?= number_format($payment['interest_amount'], 2) ?></td>
                                    <td class="fw-bold <?= $isPaid ? 'text-muted' : '' ?>">¥<?= number_format($payment['total_amount'], 2) ?></td>
                                    <td>
                                        <?php if ($isPaid): ?>
                                    ...
                                    <td>
                                        <?php if ($isPaid): ?>
                                            <span class="text-success fw-bold">¥<?= number_format((float)($payment['paid_amount'] ?? 0), 2) ?></span>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-warning text-dark">待还款</span>
                                        <?php endif; ?>
                                    </td>
...
<script>
// 标记还款弹窗
function markPaid(paymentId, dueAmount) {
