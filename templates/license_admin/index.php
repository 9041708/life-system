    ...
    <div class="card-body">
        ...
        <form class="row g-2 mb-3" method="get" action="/public/index.php">
            ...
            <div class="col-md-3">
                ...
                <input type="number" class="form-control" id="user_id" name="user_id" value="<?= htmlspecialchars($logFilters["user_id"] ?? "", ENT_QUOTES) ?>">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-12">
                ...
                <a href="?route=license-admin&tab=logs&per_page=50" class="btn btn-secondary">重置</a>
            </div>
        </form>
                    ...
                    <?php else: ?>
                        <?php foreach ($logs as $log): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($log["user_agent"], ENT_QUOTES) ?></td>
                                <td><?= htmlspecialchars($log["action"], ENT_QUOTES) ?></td>
                                <td><?= htmlspecialchars($log["details"] ?? "", ENT_QUOTES) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
