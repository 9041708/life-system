<div class="d-flex justify-content-between align-items-center mb-3">
    <div class="small text-muted">管理支出/收入分类</div>
    <button type="button" class="btn btn-sm btn-glass" data-bs-toggle="modal" data-bs-target="#modalCategoryCreate">+ 新增分类</button>
</div>
...
<!-- 新增分类弹窗 -->
<div class="modal fade mgmt-modal" id="modalCategoryCreate" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="col-12">
                        ...
                        <div class="icon-input-file d-none mb-2">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="submit_to_system" id="catCreateSubmitToSystem" value="1">
                                <label class="form-check-label small" for="catCreateSubmitToSystem">提交到公共图标库（管理员审核后可供全体用户同步使用）</label>
                            </div>
                        </div>
                            ...
                            <td>
                                ...
                                <?php if (!empty($c['icon_type']) && !empty($c['icon_value'])): ?>
                                    <?php if ($c['icon_type'] === 'file'): ?>
                                        <img src="/uploads/<?= htmlspecialchars($c['icon_value']) ?>" alt="">
...
<!-- 编辑分类弹窗 -->
<div class="modal fade mgmt-modal" id="modalCategoryEdit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" class="row g-2 align-items-end" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="icon-input-file d-none mb-2">
                            <input type="file" name="icon_file" accept="image/*" class="form-control form-control-sm">
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="submit_to_system" id="catEditSubmitToSystem" value="1">
                                <label class="form-check-label small" for="catEditSubmitToSystem">提交到公共图标库（管理员审核后可供全体用户同步使用）</label>
                            </div>
                        </div>
                        <div class="icon-input-library d-none mb-2">
                            <?php if (!empty($iconLibrary)): ?>
