<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <div class="small text-muted">支持支出/收入<?php if (!empty($transferEnabled)): ?>/转账<?php endif; ?>项目管理。</div>
    </div>
    <button type="button" class="btn btn-sm btn-glass" data-bs-toggle="modal" data-bs-target="#modalItemCreate">+ 新增项目</button>
</div>
...
<!-- 新增项目弹窗 -->
<div class="modal fade mgmt-modal" id="modalItemCreate" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="col-12">
                        ...
                        <select name="category_id" class="form-select form-select-sm" required>
                            ...
                            <?php foreach ($categories as $c): ?>
                                ...
                                ?>
                                <option value="<?= (int)$c['id'] ?>"><?= htmlspecialchars('[' . $typeLabel . '] ' . $c['name']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <div class="icon-input-file d-none mb-2">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="submit_to_system" id="itemCreateSubmitToSystem" value="1">
                                <label class="form-check-label small" for="itemCreateSubmitToSystem">提交到公共图标库（管理员审核后可供全体用户同步使用）</label>
                            </div>
                        </div>
                            ...
                            <td>
                                ...
                                <?php if (!empty($i['icon_type']) && !empty($i['icon_value'])): ?>
                                    <?php if ($i['icon_type'] === 'file'): ?>
                                        <img src="/uploads/<?= htmlspecialchars($i['icon_value']) ?>" alt="">
...
<!-- 编辑项目弹窗 -->
<div class="modal fade mgmt-modal" id="modalItemEdit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" class="row g-2 align-items-end" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="icon-input-file d-none mb-2">
                            <input type="file" name="icon_file" accept="image/*" class="form-control form-control-sm">
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="submit_to_system" id="itemEditSubmitToSystem" value="1">
                                <label class="form-check-label small" for="itemEditSubmitToSystem">提交到公共图标库（管理员审核后可供全体用户同步使用）</label>
                            </div>
                        </div>
                        <div class="icon-input-library d-none mb-2">
                            <?php if (!empty($iconLibrary)): ?>
