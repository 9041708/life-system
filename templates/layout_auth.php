...
<head>
    ...
    <title><?= htmlspecialchars(isset($systemSetting['site_name']) && $systemSetting['site_name'] !== '' ? $systemSetting['site_name'] : $appName) ?> - 登录/注册</title>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-10 col-md-7 col-lg-6 col-xl-5">
            <div class="text-center mb-4">
                <h1 class="h2 fw-bold mb-1"><?= htmlspecialchars(isset($systemSetting['site_name']) && $systemSetting['site_name'] !== '' ? $systemSetting['site_name'] : $appName) ?></h1>
