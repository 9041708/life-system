<div class="d-flex justify-content-between align-items-center mb-3">
    <div class="small text-muted">管理您的各类资金账户（银行卡、现金、电子钱包等）。</div>
    <button type="button" class="btn btn-sm btn-glass" data-bs-toggle="modal" data-bs-target="#modalAccountCreate">+ 新建账户</button>
</div>
...
<!-- 新建账户弹窗 -->
<div class="modal fade mgmt-modal" id="modalAccountCreate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">新建账户</h5>
                ...
                <form method="post" class="row g-2 align-items-end" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <select name="group_id" class="form-select form-select-sm" required>
                            <option value="">请选择账户大类</option>
                            <?php foreach ($groups as $g): ?>                                <option value="<?= (int)$g['id'] ?>"><?= htmlspecialchars($g['name']) ?></option>
                            <?php endforeach; ?>
                            </select>
                            ...
                            <div class="icon-input-file d-none mb-2">
                                ...
                                <div class="form-text small">建议使用正方形 PNG，小于 512KB。</div>
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="submit_to_system" id="accCreateSubmitToSystem" value="1">
                                        <label class="form-check-label small" for="accCreateSubmitToSystem">提交到公共图标库（管理员审核后可供全体用户同步使用）</label>
                                    </div>
                            </div>
    ...
    <div class="card-body p-3">
        ...
        <div class="table-responsive">
            <table class="table table-sm align-middle mb-0 table-accounts">
                ...
                <tr>
                    <th style="width:100px;">账户大类</th>
                    <th style="width:55px;">图标</th>
                    <th style="width:20%;">账户名称</th>
                    <th style="width:175px;">账号 / 卡号</th>
                    <th class="text-end" style="width:115px;">当前余额</th>
                    <th class="text-center" style="width:155px;">操作</th>
                </tr>
                </thead>
                <tbody>
                            ...
                            <td>
                                ...
                                <?php if (!empty($a['icon_type']) && !empty($a['icon_value'])): ?>
                                    <?php if ($a['icon_type'] === 'file'): ?>
                                        <img src="/uploads/<?= htmlspecialchars($a['icon_value']) ?>" alt="">
...
<!-- 编辑账户弹窗 -->
<div class="modal fade mgmt-modal" id="modalAccountEdit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" class="row g-2 align-items-end" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="icon-input-file d-none mb-2">
                            <input type="file" name="icon_file" accept="image/*" class="form-control form-control-sm">
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="submit_to_system" id="accEditSubmitToSystem" value="1">
                                <label class="form-check-label small" for="accEditSubmitToSystem">提交到公共图标库（管理员审核后可供全体用户同步使用）</label>
                            </div>
                        </div>
                        <div class="icon-input-library d-none mb-2">
                            <?php if (!empty($iconLibrary)): ?>
